...
> 当前版本：`v0.3.0-beta.1`（原生界面重构测试版）。自动化测试、Android Lint、Debug/Release 构建已经通过；新版界面、动画、后台与长时运行仍需在受支持的真实设备上验收，因此暂不标记稳定版。
...
| --- | --- | --- | --- |
| Android 6.0（API 23）及以上 | 支持 | APK | `v0.3.0-beta.1`，待扩展真机矩阵 |
